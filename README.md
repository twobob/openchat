...
![image](https://github.com/twobob/openchat/assets/915232/c61b2264-4580-4ec0-855a-91255cd673ca)
![image](https://github.com/twobob/openchat/assets/915232/dfcdb7d0-e569-41a1-b9a8-c4e916a0548c)
...
python gen_api_answer.py --model openchat_3.5-1210 --max-tokens 4096 --parallel 128 --openai-api-base http://localhost:18888/v1
python gen_judgment.py --model-list openchat_3.5-1210 --parallel 8 --mode single
```
...
|--------------|------|---------|-------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------|
| OpenChat 3.5 1210 | 7B   | 8192    | [Huggingface](https://huggingface.co/openchat/openchat_3.5-1210) | `python -m ochat.serving.openai_api_server --model openchat/openchat_3.5-1210 --engine-use-ray --worker-use-ray` |
